...
- [x] Implement hooks stubs (useGameSession, useReadingTimer, useQuestionScheduler, useLocalStorage)
...
Stories:
- [x] Build mock AI generation layer — generateStories.ts + generateQuestions.ts return hardcoded mock data, clearly marked with TODO comments for OpenAI swap
- [ ] Implement generateStories.ts (OpenAI structured output) — swap TODO block for real GPT-4o call
- [ ] Implement generateQuestions.ts (OpenAI structured output) — swap TODO block for real GPT-4o call
